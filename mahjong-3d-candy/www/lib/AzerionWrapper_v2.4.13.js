/*! For license information please see AzerionWrapper_v2.4.13.js.LICENSE.txt */
(() => {
    "use strict";
            ...
            8744: function(e, t, n) {
                ...
                class E extends r.EventEmitter {
                    ...
                    initOnceAllReady() {
                        let e = !1;
                        const t = () => {
                            e || (e = !0, this.checkForRemoteJS(), window.onWrapperReady && window.onWrapperReady(), this.fire(l.default.READY), this.isReady = !0)
                        };
            ...
            6722: function(e, t, n) {
                ...
                t.default = class {
                    ...
                    async loadConfig(e) {
                        ...
                        //     n = await t.json();
                        n = {
                            "gameSlug": "mahjong-3d-candy",
                            "gameBuild": "1.0.9",
                            "gameID": "bfd56375a4054ac9bd714713ce65638e",
                            "gameTitle": "Mahjong 3d Candy",
                            "interface": "sgSdk",
                            "leaderboardSupport": false,
                            "adsConfig": {
                              "adFreeInitialLevels": 0,
                              "interstitialCooldownLevel": 0,
                              "longGameplayCooldownMS": 150000,
                              "enableLongGameplayAds": true,
                              "rewarded": true,
                              "supportsAdPlayButton": false
                            }
                          };
            ...
            2673: function(e, t, n) {
                ...
                class f extends o.default {
                    ...
                    setLoadingProgress(e) {
                        const t = e || 0;
                        s.default.commsManager.setLoadingProgress(t), e >= 100 && this.interfaceRef.fire(r.InterfaceEvent.LOADED)
                    }
                    onPause(e) {}
                    getLocale() {
                ...
                class f extends s.default {
                    ...
                    async showRewardedAd() {
                        ...
                        const e = new Promise((async (e, t) => {
                            const n = () => {
                                    s(), this.fire(r.AdManagerEvent.AD_COMPLETE), this.fire(r.AdManagerEvent.AD_CLOSE), e(!0)
                                },
                                a = () => {
                                    s(), this.fire(r.AdManagerEvent.AD_ERROR), this.fire(r.AdManagerEvent.AD_CLOSE), e(!1)
                                },
                                s = () => {
                                    l.default.i.off(c.AzerionEvent.SDK_REWARDED_WATCH_COMPLETE, n), l.default.i.off(c.AzerionEvent.SDK_SKIPPED, a), l.default.i.off(c.AzerionEvent.CONTENT_RESUME_REQUESTED, a), l.default.i.off(c.AzerionEvent.SDK_GAME_START, a)
                                };
                            l.default.i.on(c.AzerionEvent.SDK_REWARDED_WATCH_COMPLETE, n), l.default.i.on(c.AzerionEvent.SDK_SKIPPED, a), l.default.i.on(c.AzerionEvent.CONTENT_RESUME_REQUESTED, a), l.default.i.on(c.AzerionEvent.SDK_GAME_START, a), i.default.sdkHandler.showAd(d.AzerionAdType.REWARDED).then((e => {})).catch((e => {}))
                        }));
                ...
                class c extends r.EventEmitter {
                    ...
                    startLongPlayAdTimer() {
                        !this.isLongPlayTimerRunning && this.isGameOrLevelPlaying && (console.log("LONG PLAY TIMER STARTED"), this.isLongPlayTimerRunning = !0, this.longPlayTimerID && window.clearInterval(this.longPlayTimerID), this._longPlayTimeLeft = i.default.config.adsConfig.longGameplayCooldownMS, this.longPlayTimerID = window.setInterval((() => {
                            this._longPlayTimeLeft -= 1e3, this.fire(l.AdTimerEvent.LONGPLAY_TICK), this._longPlayTimeLeft <= 0 ? (window.clearInterval(this.longPlayTimerID), this.onLongPlayTimerEnd()) : this._longPlayTimeLeft <= this.adRules.adWarningDuration && (this._longPlayTimeLeft == this.adRules.adWarningDuration && this.fire(l.AdTimerEvent.LONGPLAY_WARN), console.log("warning :: " + this._longPlayTimeLeft), this.fire(l.AdTimerEvent.LONGPLAY_WARN_TICK))
