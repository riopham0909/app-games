/*! For license information please see AzerionWrapper_v2.4.5.js.LICENSE.txt */
(() => {
	"use strict";
					...
					async getRewardedVideoAsync(e) {
						return Promise.resolve({
							...
							showAsync: () => new Promise((async (e, t) => {
								e(await i.default.adManager.showRewardedAd())
							})),
					...
					async showRewardedAd() {
						...
						const e = new Promise((async (e, t) => {
							const n = () => {
								...
								s = () => {
									l.default.i.off(c.AzerionEvent.SDK_ERROR, a), l.default.i.off(c.AzerionEvent.SDK_COMPLETE, n), l.default.i.off(c.AzerionEvent.SDK_REWARDED_WATCH_COMPLETE, n), l.default.i.off(c.AzerionEvent.SDK_SKIPPED, a)
								};
							l.default.i.once(c.AzerionEvent.SDK_ERROR, a), l.default.i.once(c.AzerionEvent.SDK_COMPLETE, n), l.default.i.once(c.AzerionEvent.SDK_REWARDED_WATCH_COMPLETE, n), l.default.i.once(c.AzerionEvent.SDK_SKIPPED, a), i.default.sdkHandler.showAd(d.AzerionAdType.REWARDED).then((e => {})).catch((t => {
