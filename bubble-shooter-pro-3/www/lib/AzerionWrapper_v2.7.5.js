	...
	var __webpack_modules__ = {
			1075: e => {
				...
				Object.create && (a.prototype = Object.create(null), (new a).__proto__ || (n = !1)), s.prototype.eventNames = function() {
					...
					if (!a) return [];
					if (a.fn) return [a.fn];
					for (var r = 0, i = a.length, o = new Array(i); r < i; r++) o[r] = a[r].fn;
					return o
					...
					if (s.fn) s.fn !== t || r && !s.once || a && s.context !== a || o(this, i);
					else {
						for (var l = 0, d = [], c = s.length; l < c; l++)(s[l].fn !== t || r && !s[l].once || a && s[l].context !== a) && d.push(s[l]);
			...
			8744: function(e, t, n) {
				...
				class v extends r.default {
					constructor() {
						super(), this.isReady = !1, this.gameStarted = !1, this.interface = new r.default, o.default.setupUIStyle()
					}
					static get instance() {
					...
					createUI(e) {
						...
						})), this.countdownTag = new g.default, v.instance.platformDefaults.useAdLoader && (this.adLoadBg = new h.default);
					...
					hookUpInterface() {
						this.interface.once(s.InterfaceEvent.LOADED, (() => {})), this.interface.once(s.InterfaceEvent.LOADED, (() => {
							this.onStartGame()
			...
			9284: function(e, t, n) {
				...
				class h extends g.default {
					async createWrapper(e) {
						f.default.instance.config = e, f.default.instance.platformDefaults = new c.default, e.platform = r.PlatformType.AZERION, f.default.instance.storageManager = new d.default, f.default.instance.commsManager = new s.default, f.default.instance.adManager = new o.default, f.default.instance.placementIDs = {
							rewarded: f.default.config.gameID,
							interstitial: f.default.config.gameID
						}, f.default.instance.iapManager = new l.default, f.default.instance.SGPreloader = new u.default(!1), f.default.instance.init(e), !0 === e.leaderboardSupport && (f.default.instance.leaderboards = await this.getLeaderboardHandler(i.LeaderboardTypes.FIREBASE)), f.default.instance.onStart()
					}
				}
				t.default = h, new h
			},
					...
					async getRewardedVideoAsync(e) {
						return Promise.resolve({
							...
							showAsync: () => new Promise((async (e, t) => {
								await r.default.adManager.showRewardedAd() ? e(!0) : (0, o.getConfigOption)("rejectFailedRewarded") ? t() : e(!1)
							})),
				...
				class d extends s.default {
					...
					async trigger(e, t) {
						switch (e) {
							...
							case l.SGSDKTriggers.MORE_GAMES || l.SGSDKTriggers.GAME_TRACKING || l.SGSDKTriggers.PAGE_DISPLAY:
						}
					}
				}
				t.default = d
					...
					async showRewardedAd() {
						...
						const t = new Promise((async (t, n) => {
							const a = () => {
								...
								i = () => {
									o(), this.emit(r.AdManagerEvent.AD_CLOSE), this.emit(e ? r.AdManagerEvent.AD_COMPLETE : r.AdManagerEvent.AD_ERROR), t(e)
								},
								o = () => {
									l.default.i.removeListener(c.AzerionEvent.SDK_REWARDED_WATCH_COMPLETE, a), l.default.i.removeListener(c.AzerionEvent.SDK_SKIPPED, i), l.default.i.removeListener(c.AzerionEvent.CONTENT_RESUME_REQUESTED, i), l.default.i.removeListener(c.AzerionEvent.SDK_GAME_START, i)
								};
							l.default.i.on(c.AzerionEvent.SDK_REWARDED_WATCH_COMPLETE, a), l.default.i.on(c.AzerionEvent.SDK_SKIPPED, i), l.default.i.on(c.AzerionEvent.CONTENT_RESUME_REQUESTED, i), l.default.i.on(c.AzerionEvent.SDK_GAME_START, i), this.sdkRef.showAd(d.AzerionAdType.REWARDED)
						}));
				...
				class u extends l.default {
					...
					async initialize() {
						...
						return function(e, t, n) {
							...
							this.hasPaused = !0, s.default.instance.emit(i.default.GAME_PAUSE)
						})), d.default.i.on(c.AzerionEvent.SDK_GAME_START, (() => {
							this.hasPaused && s.default.instance.emit(i.default.GAME_RESUME), this.hasPaused = !1
						})), e
					}
					async startGame() {
						return Promise.resolve({
			...
			9167: function(e, t, n) {
				...
				class c extends r.default {
					...
					async initialize() {
						this.setupTimer(), d.default.interface.on(s.GameEvent.GAME_OVER, (e => {
							this.onGameOver(e)
			...
			5522: function(e, t, n) {
				...
				class c extends r.default {
					...
					initialize(e) {
						...
						}))), this.handleFreeRewardedTimer(), i.default.adManager.on(s.AdManagerEvent.AD_SKIP, (() => {
							this.onAdPlayed()
					...
					handleFreeRewardedTimer() {
						this._freeRewardedReady = !0, i.default.adManager.on(s.AdManagerEvent.FREE_REWARD_AWARDED, (() => {
					...
					onLongPlayTimerEnd() {
						this._longPlayTimeLeft = i.default.config.adsConfig.longGameplayCooldownMS, i.default.adManager.once(s.AdManagerEvent.AD_CLOSE, (() => {
			...
			247: function(e, t, n) {
				...
				t.default = class {
					...
					async save() {
						return !this.canSaveNow && (0, i.getConfigOption)("limitSaveCalls") ? (clearTimeout(this.retryTimeOut), void(this.retryTimeOut = setTimeout((() => {
							this.save()
			...
			1840: function(e, t, n) {
				...
				t.default = class {
					constructor() {
						...
						this.tag = document.createElement("div"), this.tag.setAttribute("class", "countdown-tag"), e.appendChild(this.tag), this.textfield = document.createElement("h4"), this.textfield.setAttribute("class", "countdown-tag-label"), this.tag.appendChild(this.textfield), o.default.adManager.adTimer.on(i.AdTimerEvent.LONGPLAY_WARN, (() => {
							this.show()
						})), o.default.adManager.adTimer.on(i.AdTimerEvent.LONGPLAY_WARN_TICK, (() => {
			...
			5038: function(e, t, n) {
				...
				class c {
					...
					build() {
						...
						s.setAttribute("class", "termsAndConditionsLinkText"), s.innerHTML = "<a target='_blank' href='" + u + "'>" + i.TEXTS[c].tos + "</a>", d.setAttribute("class", "privacyPolicyLinkText"), d.innerHTML = "<a target='_blank' href='" + f + "'>" + i.TEXTS[c].privacy + "</a>", this.playerIdText = document.createElement("div"), this.playerIdText.setAttribute("class", "playerIdText"), this.container.appendChild(n), this.container.appendChild(a), this.container.appendChild(s), this.container.appendChild(d), this.container.appendChild(this.playerIdText)
					}
					show() {
			...
			6456: (e, t) => {
				...
				Object.defineProperty(t, "__esModule", {
					...
					if (t && (o.id = t), r && o.setAttribute("style", r), (i || document.body).appendChild(o), a) {
						const e = function(e) {
							return new Promise((t => {
								e.onload = () => {
									t()
			...
			9233: (e, t, n) => {
				...
				const p = function(e, t, n) {
						...
						if (null == o || null == s) {
							...
							null == o && (o = u = [1 | l[0], l[1], l[2], l[3], l[4], l[5]]), null == s && (s = f = 16383 & (l[6] << 8 | l[7]))
						}
						var d = void 0 !== e.msecs ? e.msecs : Date.now(),
							p = void 0 !== e.nsecs ? e.nsecs : h + 1,
							_ = d - g + (p - h) / 1e4;
						if (_ < 0 && void 0 === e.clockseq && (s = s + 1 & 16383), (_ < 0 || d > g) && void 0 === e.nsecs && (p = 0), p >= 1e4) throw new Error("uuid.v1(): Can't create more than 10M uuids/sec");
						g = d, h = p, f = s;
						...
						r[a++] = A >>> 8 & 255, r[a++] = 255 & A, r[a++] = A >>> 24 & 15 | 16, r[a++] = A >>> 16 & 255, r[a++] = s >>> 8 | 128, r[a++] = 255 & s;
				...
				function m(e, t, n) {
					function a(e, a, r, i) {
						...
						if (o.set(a), o.set(e, a.length), (o = n(o))[6] = 15 & o[6] | t, o[8] = 63 & o[8] | 128, r) {
							i = i || 0;
				...
				function v(e, t, n, a, r, i) {
					return E((o = E(E(t, e), E(a, i))) << (s = r) | o >>> 32 - s, n);
					var o, s
				}
						...
						return function(e) {
							...
							for (var n = 1732584193, a = -271733879, r = -1732584194, i = 271733878, o = 0; o < e.length; o += 16) {
								var s = n,
									...
									d = r,
									c = i;
								n = S(n, a, r, i, e[o], 7, -680876936), i = S(i, n, a, r, e[o + 1], 12, -389564586), r = S(r, i, n, a, e[o + 2], 17, 606105819), a = S(a, r, i, n, e[o + 3], 22, -1044525330), n = S(n, a, r, i, e[o + 4], 7, -176418897), i = S(i, n, a, r, e[o + 5], 12, 1200080426), r = S(r, i, n, a, e[o + 6], 17, -1473231341), a = S(a, r, i, n, e[o + 7], 22, -45705983), n = S(n, a, r, i, e[o + 8], 7, 1770035416), i = S(i, n, a, r, e[o + 9], 12, -1958414417), r = S(r, i, n, a, e[o + 10], 17, -42063), a = S(a, r, i, n, e[o + 11], 22, -1990404162), n = S(n, a, r, i, e[o + 12], 7, 1804603682), i = S(i, n, a, r, e[o + 13], 12, -40341101), r = S(r, i, n, a, e[o + 14], 17, -1502002290), n = y(n, a = S(a, r, i, n, e[o + 15], 22, 1236535329), r, i, e[o + 1], 5, -165796510), i = y(i, n, a, r, e[o + 6], 9, -1069501632), r = y(r, i, n, a, e[o + 11], 14, 643717713), a = y(a, r, i, n, e[o], 20, -373897302), n = y(n, a, r, i, e[o + 5], 5, -701558691), i = y(i, n, a, r, e[o + 10], 9, 38016083), r = y(r, i, n, a, e[o + 15], 14, -660478335), a = y(a, r, i, n, e[o + 4], 20, -405537848), n = y(n, a, r, i, e[o + 9], 5, 568446438), i = y(i, n, a, r, e[o + 14], 9, -1019803690), r = y(r, i, n, a, e[o + 3], 14, -187363961), a = y(a, r, i, n, e[o + 8], 20, 1163531501), n = y(n, a, r, i, e[o + 13], 5, -1444681467), i = y(i, n, a, r, e[o + 2], 9, -51403784), r = y(r, i, n, a, e[o + 7], 14, 1735328473), n = T(n, a = y(a, r, i, n, e[o + 12], 20, -1926607734), r, i, e[o + 5], 4, -378558), i = T(i, n, a, r, e[o + 8], 11, -2022574463), r = T(r, i, n, a, e[o + 11], 16, 1839030562), a = T(a, r, i, n, e[o + 14], 23, -35309556), n = T(n, a, r, i, e[o + 1], 4, -1530992060), i = T(i, n, a, r, e[o + 4], 11, 1272893353), r = T(r, i, n, a, e[o + 7], 16, -155497632), a = T(a, r, i, n, e[o + 10], 23, -1094730640), n = T(n, a, r, i, e[o + 13], 4, 681279174), i = T(i, n, a, r, e[o], 11, -358537222), r = T(r, i, n, a, e[o + 3], 16, -722521979), a = T(a, r, i, n, e[o + 6], 23, 76029189), n = T(n, a, r, i, e[o + 9], 4, -640364487), i = T(i, n, a, r, e[o + 12], 11, -421815835), r = T(r, i, n, a, e[o + 15], 16, 530742520), n = P(n, a = T(a, r, i, n, e[o + 2], 23, -995338651), r, i, e[o], 6, -198630844), i = P(i, n, a, r, e[o + 7], 10, 1126891415), r = P(r, i, n, a, e[o + 14], 15, -1416354905), a = P(a, r, i, n, e[o + 5], 21, -57434055), n = P(n, a, r, i, e[o + 12], 6, 1700485571), i = P(i, n, a, r, e[o + 3], 10, -1894986606), r = P(r, i, n, a, e[o + 10], 15, -1051523), a = P(a, r, i, n, e[o + 1], 21, -2054922799), n = P(n, a, r, i, e[o + 8], 6, 1873313359), i = P(i, n, a, r, e[o + 15], 10, -30611744), r = P(r, i, n, a, e[o + 6], 15, -1560198380), a = P(a, r, i, n, e[o + 13], 21, 1309151649), n = P(n, a, r, i, e[o + 4], 6, -145523070), i = P(i, n, a, r, e[o + 11], 10, -1120210379), r = P(r, i, n, a, e[o + 2], 15, 718787259), a = P(a, r, i, n, e[o + 9], 21, -343485551), n = E(n, s), a = E(a, l), r = E(r, d), i = E(i, c)
							}
							return [n, a, r, i]
						}(function(e) {
				...
				const I = m("v5", 80, (function(e) {
						...
						e.push(128);
						for (var i = e.length / 4 + 2, o = Math.ceil(i / 16), s = new Array(o), l = 0; l < o; ++l) {
						...
						for (var u = 0; u < o; ++u) {
							for (var f = new Uint32Array(80), g = 0; g < 16; ++g) f[g] = s[u][g];
							for (var h = 16; h < 80; ++h) f[h] = D(f[h - 3] ^ f[h - 8] ^ f[h - 14] ^ f[h - 16], 1);
							for (var p = n[0], _ = n[1], m = n[2], A = n[3], E = n[4], v = 0; v < 80; ++v) {
								var S = Math.floor(v / 20),
									y = D(p, 5) + b(S, _, m, A) + E + t[S] + f[v] >>> 0;
								E = A, A = m, m = D(_, 30) >>> 0, _ = p, p = y
							}
							n[0] = n[0] + p >>> 0, n[1] = n[1] + _ >>> 0, n[2] = n[2] + m >>> 0, n[3] = n[3] + A >>> 0, n[4] = n[4] + E >>> 0
						}
