/** Softgames Azerion Wrapper v2.7.14 */
(() => {
    "use strict";
    var __webpack_modules__ = {
            1075: e => {
                ...
                Object.create && (a.prototype = Object.create(null), (new a).__proto__ || (n = !1)), s.prototype.eventNames = function() {
                    ...
                    if (c.fn) {
                        ...
                        var f, _ = c.length;
                        for (d = 0; d < _; d++) switch (c[d].once && this.removeListener(e, c[d].fn, void 0, !0), u) {
                            case 1:
            ...
            8744: function(e, t, n) {
                ...
                class E extends r.default {
                    ...
                    createUI(e) {
                        ...
                        })), this.countdownTag = new _.default, E.instance.platformDefaults.useFakeAdLoader && (this.adLoadBg = new g.default);
                        const t = (0, m.getConfigOptionAny)("lockOrientation");
                        t !== A.OrientationLock.NONE && null !== t && new v.default
                    }
                    async initAds() {
            ...
            388: (e, t) => {
                ...
                class n {}
                t.default = n, n.imagePath = "https://assets.gd.sbs.softgames.de/assets/wrapper_images/", n.platformConfig = "platform-config.json", n.ratingImage = n.imagePath + "grac_kr_rating_all.png", n.softgamesLogo = n.imagePath + "softgames_logo.png", n.supportPopupBG = n.imagePath + "support_popup.png", n.supportPopupTextFrame = n.imagePath + "support_text_frame.png", n.supportPopupCloseBtn = n.imagePath + "support_close_button.png", n.firebaseConfig = "firebaseConfig.json"
            },
            5028: (e, t) => {
                Object.defineProperty(t, "__esModule", {
                        value: !0
            ...
            2673: function(e, t, n) {
                ...
                class g extends s.default {
                    constructor(e) {
                        super(e), this.player = new c.default, this.payments = new d.default, this.tournament = new u.default, this.context = new l.default, this.community = new f.default, this.graphApi = new _.default, window.FBInstant = this
                    }
                    initializeAsync() {
                ...
                class c extends s.default {
                    ...
                    initialize(e, t, n) {
                        ...
                        let a = {
                            ...
                            config: {
                                env: {
                                    locale: o.default.commsManager.getLanguage(t.supportedLanguages)
                                },
                                rewarded: {
                                    enabled: !0
                                },
                    ...
                    async trigger(e, t) {
                        switch (e) {
                            ...
                            case l.SGSDKTriggers.SHARE:
                                const s = o.default.commsManager.getLanguage(),
                                    c = d.TEXTS[s];
                                if (o.default.commsManager.shareAsync({
                                        title: c.share_title,
                                        text: t.shareText,
                                        image: t.shareImage
                                    }), t.callback) return void t.callback();
            ...
            5207: function(e, t, n) {
                ...
                class u extends o.default {
                    async initialize() {
                        super.initialize(), this.sdkRef = i.default.sdkHandler, l.default.i.on(c.AzerionEvent.CONTENT_PAUSE_REQUESTED, (() => {
                    ...
                    async showRewardedAd() {
                        ...
                        const t = new Promise((async (t, n) => {
                            const a = () => {
                                ...
                                o = () => {
                                    l.default.i.removeListener(c.AzerionEvent.SDK_REWARDED_WATCH_COMPLETE, a), l.default.i.removeListener(c.AzerionEvent.SDK_SKIPPED, (() => {
                                        i()
                                    })), l.default.i.removeListener(c.AzerionEvent.CONTENT_RESUME_REQUESTED, i), l.default.i.removeListener(c.AzerionEvent.SDK_GAME_START, i)
                                };
                ...
                class l {
                    ...
                    build() {
                        const e = r.default.commsManager.getLanguage(),
                            t = s.TEXTS[e];
                        this.root = (0, o.getUIRoot)(), this.bg = document.createElement("div"), this.bg.setAttribute("class", "fakeRewarded-screen"), this.closeBtn = document.createElement("div"), this.closeBtn.setAttribute("class", "FakeAdCloseBtn"), this.closeBtn.addEventListener("pointerup", (() => {
                            this.onAdClosed()
                    ...
                    startTimer() {
                        ...
                        this.rewardTimer = setInterval((() => {
                            ...
                            const i = "<span style='font-weight:bold;'>" + e + "</span>",
                                o = a.ad_time;
                            this.progressText.innerHTML = o.replace("[x]", i), console.log(e), 0 == e && (clearInterval(this.rewardTimer), this.onRewardTimerEnd())
                        }), 1e3)
                    }
                    static async show() {
            ...
            5038: function(e, t, n) {
                ...
                class c {
                    ...
                    build() {
                        ...
                        s.setAttribute("class", "termsAndConditionsLinkText"), s.innerHTML = "<a target='_blank' href='" + u + "'>" + i.TEXTS[c].tos + "</a>", d.setAttribute("class", "privacyPolicyLinkText"), d.innerHTML = "<a target='_blank' href='" + f + "'>" + i.TEXTS[c].privacy + "</a>", this.playerIdText = document.createElement("div"), this.playerIdText.setAttribute("class", "playerIdText");
                        const _ = document.createElement("div");
                        _.setAttribute("class", "contactUs"), _.innerText = "Contact Us:";
                        const g = document.createElement("div");
                        g.setAttribute("class", "supportEmail"), g.innerText = "support-samsung@softgames.de", this.container.appendChild(n), this.container.appendChild(a), this.container.appendChild(s), this.container.appendChild(d), this.container.appendChild(_), this.container.appendChild(g), this.container.appendChild(this.playerIdText)
                    }
                    show() {
                    ...
                    for (let e = 0; e < o; ++e) {
                        ...
                        for (let e = 0; e < 80; ++e) {
                            const r = Math.floor(e / 20),
                                s = a(o, 5) + n(r, l, d, c) + u + t[r] + i[e] >>> 0;
                            u = c, c = d, d = a(l, 30) >>> 0, l = o, o = s
                        }
                        r[0] = r[0] + o >>> 0, r[1] = r[1] + l >>> 0, r[2] = r[2] + d >>> 0, r[3] = r[3] + c >>> 0, r[4] = r[4] + u >>> 0
                    }
            ...
            2838: (e, t, n) => {
                ...
                var c = function(e, t, n) {
                    ...
                    if (null == u || null == f) {
                        ...
                        null == u && (u = o = [1 | t[0], t[1], t[2], t[3], t[4], t[5]]), null == f && (f = s = 16383 & (t[6] << 8 | t[7]))
                    }
                    let _ = void 0 !== e.msecs ? e.msecs : Date.now(),
                        g = void 0 !== e.nsecs ? e.nsecs : d + 1;
                    const h = _ - l + (g - d) / 1e4;
                    if (h < 0 && void 0 === e.clockseq && (f = f + 1 & 16383), (h < 0 || _ > l) && void 0 === e.nsecs && (g = 0), g >= 1e4) throw new Error("uuid.v1(): Can't create more than 10M uuids/sec");
                    l = _, d = g, s = f, _ += 122192928e5;
                    const p = (1e4 * (268435455 & _) + g) % 4294967296;
                    c[a++] = p >>> 24 & 255, c[a++] = p >>> 16 & 255, c[a++] = p >>> 8 & 255, c[a++] = 255 & p;
                    const m = _ / 4294967296 * 1e4 & 268435455;
                    c[a++] = m >>> 8 & 255, c[a++] = 255 & m, c[a++] = m >>> 24 & 15 | 16, c[a++] = m >>> 16 & 255, c[a++] = f >>> 8 | 128, c[a++] = 255 & f;
            ...
            1396: (e, t, n) => {
                ...
                var o = (0, a.default)("v3", 48, r.default);
                t.default = o
            },
            5125: (e, t, n) => {
                Object.defineProperty(t, "__esModule", {
                    ...
                    function a(e, a, o, s) {
                        ...
                        if (d.set(a), d.set(e, a.length), d = n(d), d[6] = 15 & d[6] | t, d[8] = 63 & d[8] | 128, o) {
                            s = s || 0;
                            for (let e = 0; e < 16; ++e) o[s + e] = d[e];
                            return o
                        }
            ...
            1337: (e, t, n) => {
                ...
                var o = (0, a.default)("v5", 80, r.default);
                t.default = o
            },
            6108: (e, t, n) => {
                Object.defineProperty(t, "__esModule", {
